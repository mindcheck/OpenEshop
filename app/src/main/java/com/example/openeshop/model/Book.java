package com.example.openeshop.model;
...
public class Book extends BaseObservable {
    ...
    public void setBookId(int bookId) {
        this.bookId = bookId;
        notifyPropertyChanged(com.example.openeshop.BR.bookId);
    ...
    public void setBookName(String bookName) {
        this.bookName = bookName;
        notifyPropertyChanged(com.example.openeshop.BR.bookName);
    ...
    public void setUnitPrice(String unitPrice) {
        this.unitPrice = unitPrice;
        notifyPropertyChanged(com.example.openeshop.BR.unitPrice);
    ...
    public void setCategoryId(int categoryId) {
        this.categoryId = categoryId;
        notifyPropertyChanged(com.example.openeshop.BR.categoryId);
